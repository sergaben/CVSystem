    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row" id="breadCrumb">
                <div class="col-xs-12">
                    <ol class="breadcrumb" style="background-color: white; margin-top: 2%; margin-bottom: 0;">
                        <li><a href="studentCVpage.php">Dashboard</a></li>
            ...
            <div class="row" id="welcome">
                <div class="col-xs-12" >
                    <h2 class="SubTitle"><?php echo htmlentities(ucfirst($username));?>, this is your CV </h2>
            ...
            <div class="row" id="cvDisplay">
                <div class="col-xs-12">
                    ...
                    <h3 class="threeSubtitle"><?php echo "CV Name goes here"; ?></h3>
                    <div class="displayCV">
...
//                                
            ...
            <div class="row" id="feedback">
                <div class="col-xs-12">
                    ...
                    $reaction = getFeedback($_GET['staff'],$_GET['cv']); 
                    ?>
