                ...
                <div class="col-xs-12">
                    <div  class="container-fluid centerText"id="ButtonsContainers">
                        ...
                        <div class="centerText btn-toolbar" id="changeLogin" role="group" aria-label="...">
                            ...
                            <button type="button"  class="button btn-primary btn-lg" class="loginButton">Student Login</button>
            ...
            <div class="row" id="loginForm">
                <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                    <div  class="centerText container-fluid" id="loginContainer">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                            <div class="containerFluid" id="loginFormContainer">
                                ...
                                <div class="form-group" id="loginUsername">
                                    ...
                                    <label for="username" >Username:</label> <input type="text" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Username" name="username">
                                </div>
                        ...
                        <div class="links">
                            <div><h4><a href="Student/SignUpPageStudent.php">Sign Up</a></h4></div>
